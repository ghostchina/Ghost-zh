...
var _              = require('lodash'),
    ...
    configureGrunt = function (grunt) {
        ...
        grunt.registerTask('release-full', 'Create zip package with all needed node modules.',
           ['clean:all', 'init', 'concat:prod', 'copy:prod', 'emberBuildProd', 'uglify:release', 'clean:release',
                'shell:shrinkwrap', 'copy:release', 'compress:release', 'shell:sqlite-bindings', 'copy:full', 'compress:release-full']);
    };
